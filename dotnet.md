...
<!-- news_marker starts -->
- Modernize .NET Anywhere with GitHub Copilot ([13 hours ago](https://devblogs.microsoft.com/dotnet/modernize-dotnet-anywhere-with-ghcp/))
- .NET 10.0.5 Out-of-Band Release – macOS Debugger Fix ([13 hours ago](https://devblogs.microsoft.com/dotnet/dotnet-10-0-5-oob-release-macos-debugger-fix/))
