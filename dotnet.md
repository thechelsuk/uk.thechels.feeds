...
<!-- news_marker starts -->
- SkiaSharp 4.0 is here: announcing the first stable release ([27 minutes ago](https://devblogs.microsoft.com/dotnet/skiasharp-4-0-stable/))
- Packaging and Package Identity for .NET apps with WinApp CLI on Windows ([4 hours ago](https://devblogs.microsoft.com/dotnet/packaging-dotnet-apps-winapp/))
