...
<!-- news_marker starts -->
- .NET 8 and .NET 9 will reach End of Support on November 10, 2026 ([8 hours ago](https://devblogs.microsoft.com/dotnet/dotnet-8-9-end-of-support/))
- SkiaSharp 4.0 is here: announcing the first stable release ([9 hours ago](https://devblogs.microsoft.com/dotnet/skiasharp-4-0-stable/))
- Packaging and Package Identity for .NET apps with WinApp CLI on Windows ([13 hours ago](https://devblogs.microsoft.com/dotnet/packaging-dotnet-apps-winapp/))
