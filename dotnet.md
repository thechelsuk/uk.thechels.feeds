...
<!-- news_marker starts -->
- Modernize .NET applications in the GitHub Copilot app ([4 hours ago](https://devblogs.microsoft.com/dotnet/modernize-dotnet-in-github-copilot-app/))
...
- MCP Beyond the Chat Window: Build Diagnostics in CI ([9 days ago](https://devblogs.microsoft.com/dotnet/mcp-build-diagnostics-workflows/))
...
- SkiaSharp 4.0 is here: announcing the first stable release ([10 days ago](https://devblogs.microsoft.com/dotnet/skiasharp-4-0-stable/))
