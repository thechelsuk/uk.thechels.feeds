...
<!-- news_marker starts -->
- .NET Conf 2026 ([6 hours ago](https://devblogs.microsoft.com/dotnet/dotnet-conf-2026/))
- Finding the total number of processors on a machine with .NET ([13 hours ago](https://andrewlock.net/finding-the-total-number-of-processors-on-a-machine-with-dotnet/))
