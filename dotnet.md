...
<!-- news_marker starts -->
- Welcome to SkiaSharp 4.0 Preview 1 ([4 hours ago](https://devblogs.microsoft.com/dotnet/welcome-to-skia-sharp-40-preview1/))
- High-Performance Distributed Caching with .NET and Postgres on Azure ([4 hours ago](https://devblogs.microsoft.com/dotnet/high-performance-distributed-caching-dotnet-postgres-azure/))
- New features in Git 2.54: easier rebasing, hooks, and statistics ([11 hours ago](https://andrewlock.net/new-features-in-git-2-54-easier-rebasing-hooks-and-statistcs/))
