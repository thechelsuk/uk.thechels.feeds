...
<!-- news_marker starts -->
- From dotnet run to Foundry Hosted Agent in 3 lines of C# ([7 hours ago](https://devblogs.microsoft.com/dotnet/from-dotnet-run-to-foundry-hosted-agent-in-3-lines-of-csharp/))
- Explore new features available in C# 15 preview ([9 hours ago](https://devblogs.microsoft.com/dotnet/explore-csharp-15/))
