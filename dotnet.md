...
<!-- news_marker starts -->
- Governing MCP tool calls in .NET with the Agent Governance Toolkit ([23 hours ago](https://devblogs.microsoft.com/dotnet/governing-mcp-tool-calls-in-dotnet-with-the-agent-governance-toolkit/))
- VSTest is Removing its Newtonsoft.Json Dependency ([23 hours ago](https://devblogs.microsoft.com/dotnet/vs-test-is-removing-its-newtonsoft-json-dependency/))
