...
<!-- news_marker starts -->
- Isolate the swiyu Public Beta management APIs using YARP ([22 hours ago](https://dotnetkicks.com/r/739624?url=https://damienbod.com/2026/02/09/isolate-the-swiyu-public-beta-management-apis-using-yarp/))
...
- Boost Your .NET Projects with Spargine: Global Phone Number and Postal Code Validation Made Easy ([2 days ago](https://dotnettips.wordpress.com/2026/02/08/boost-your-net-projects-with-spargine-global-phone-number-and-postal-code-validation-made-easy/))
...
- .NET Framework 3.5 Moves to Standalone Deployment in new versions of Windows - .NET Blog ([4 days ago](https://dotnetkicks.com/r/739519?url=https://devblogs.microsoft.com/dotnet/dotnet-framework-3-5-moves-to-standalone-deployment-in-new-versions-of-windows/))
- .NET Framework 3.5 Moves to Standalone Deployment in new versions of Windows ([4 days ago](https://devblogs.microsoft.com/dotnet/dotnet-framework-3-5-moves-to-standalone-deployment-in-new-versions-of-windows/))
...
- Use client assertions in ASP.NET Core using OpenID Connect, OAuth DPoP and OAuth PAR ([7 days ago](https://dotnetkicks.com/r/739158?url=https://damienbod.com/2026/02/02/use-client-assertions-in-asp-net-core-using-openid-connect-oauth-dpop-and-oauth-par/))
...
- Game Dev in 2025: Excerpts From the State of Game Development Report ([11 days ago](https://blog.jetbrains.com/dotnet/2026/01/29/game-dev-in-2025-excerpts-from-the-state-of-game-development-report/))
...
- Boost Your .NET Projects with Spargine: Supercharge Your .NET Apps with NetworkHelper ([13 days ago](https://dotnettips.wordpress.com/2026/01/28/boost-your-net-projects-with-spargine-supercharge-your-net-apps-with-networkhelper/))
- Security Software False Positives ([13 days ago](https://dotnetkicks.com/r/739027?url=https://textslashplain.com/2026/01/27/microsoft-defender-false-positives/))
- Prepare for Launch: Enrichment Strategies for Apache Flink ([13 days ago](https://dotnetkicks.com/r/738968?url=https://rion.io/2026/01/27/prepare-for-launch-enrichment-strategies-for-apache-flink/))
...
- Force step up authentication in web applications ([14 days ago](https://dotnetkicks.com/r/738839?url=https://damienbod.com/2026/01/26/force-step-up-authentication-in-web-applications/))
...
- ReSharper 2026.1 Early Access Program Has Begun ([18 days ago](https://blog.jetbrains.com/dotnet/2026/01/22/resharper-2026-1-early-access-program/))
- Rider 2026.1 Early Access Program Is Now Open! ([18 days ago](https://blog.jetbrains.com/dotnet/2026/01/22/rider-2026-1-early-access-program-start/))
- Making foreach on an IEnumerable allocation-free using reflection and dynamic methods ([20 days ago](https://andrewlock.net/making-foreach-on-an-ienumerable-allocation-free-using-reflection-and-dynamic-methods/))
- Collection Performance: High-Performance Collection Randomization in .NET ([23 days ago](https://dotnettips.wordpress.com/2026/01/18/collection-performance-high-performance-collection-randomization-in-net/))
- .NET and .NET Framework January 2026 servicing releases updates ([27 days ago](https://devblogs.microsoft.com/dotnet/dotnet-and-dotnet-framework-january-2026-servicing-updates/))
- The Windows File Explorer replacement, File Pilot, is awesome ([27 days ago](https://andrewlock.net/windows-explorer-replacement-filepilot-is-awesome/))
- How to Build Android Widgets with .NET MAUI ([28 days ago](https://devblogs.microsoft.com/dotnet/how-to-build-android-widgets-with-dotnet-maui/))
- How We Synchronize .NET’s Virtual Monorepo ([28 days ago](https://devblogs.microsoft.com/dotnet/how-we-synchronize-dotnets-virtual-monorepo/))
