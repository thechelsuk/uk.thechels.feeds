...
<!-- news_marker starts -->
- .NET Conf 2026 ([10 hours ago](https://devblogs.microsoft.com/dotnet/dotnet-conf-2026/))
- Finding the total number of processors on a machine with .NET ([17 hours ago](https://andrewlock.net/finding-the-total-number-of-processors-on-a-machine-with-dotnet/))
...
- Migrating a Synology NAS to a UniFi UNAS Pro 8 with Robocopy, SMB Multichannel, and Surprising Performance Traps ([2 days ago](http://feeds.hanselman.com/~/968151545/0/scotthanselman~Migrating-a-Synology-NAS-to-a-UniFi-UNAS-Pro-with-Robocopy-SMB-Multichannel-and-Surprising-Performance-Traps))
...
- Routing and Failover for Microsoft.Extensions.AI ([12 days ago](https://devblogs.microsoft.com/dotnet/routing-and-failover-for-microsoft-extensions-ai/))
- Dew Drop - August 13, 2026 (#4732) ([12 days ago](https://alvinashcraft.com/2026/08/13/dew-drop-august-13-2026-4732/))
- Instructions Hygiene – What Frontier Models Still Need You to Say ([13 days ago](https://devblogs.microsoft.com/dotnet/instructions-hygiene-what-frontier-models-still-need-you-to-say/))
