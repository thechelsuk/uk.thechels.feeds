...
<!-- news_marker starts -->
- Welcome to SkiaSharp 4.0 Preview 1 ([14 hours ago](https://devblogs.microsoft.com/dotnet/welcome-to-skia-sharp-40-preview1/))
- High-Performance Distributed Caching with .NET and Postgres on Azure ([14 hours ago](https://devblogs.microsoft.com/dotnet/high-performance-distributed-caching-dotnet-postgres-azure/))
- New features in Git 2.54: easier rebasing, hooks, and statistics ([21 hours ago](https://andrewlock.net/new-features-in-git-2-54-easier-rebasing-hooks-and-statistcs/))
...
- Removing byte[] allocations in .NET Framework using ReadOnlySpan<T -  ([7 days ago](https://andrewlock.net/removingbyte-array-allocations-in-dotnet-framework-using-readonlyspan-t/))
...
- Guidance Counselor 2.0 with David McCarter ([8 days ago](https://dotnettips.com/2026/04/20/guidance-counselor-2-0-with-david-mccarter/))
- String Performance: Why Some String Searches Are Slower Than You Think ([9 days ago](https://dotnettips.com/2026/04/19/string-performance-why-some-string-searches-are-slower-than-you-think/))
- Pin Clustering in .NET MAUI Maps ([13 days ago](https://devblogs.microsoft.com/dotnet/pin-clustering-in-dotnet-maui-maps/))
- .NET and .NET Framework April 2026 servicing releases updates ([14 days ago](https://devblogs.microsoft.com/dotnet/dotnet-and-dotnet-framework-april-2026-servicing-updates/))
- .NET 11 Preview 3 is now available! ([14 days ago](https://devblogs.microsoft.com/dotnet/dotnet-11-preview-3/))
- Running AI agents with customized templates using docker sandbox ([14 days ago](https://andrewlock.net/running-ai-agents-with-customized-templates-in-docker-sandbox/))
- Collection Performance: High-Performance Emptiness Checks for Concurrent & Immutable Collections ([17 days ago](https://dotnettips.com/2026/04/12/collection-performance-high-performance-emptiness-checks-for-concurrent-immutable-collections/))
...
- String Performance: Avoid Unnecessary Conversions with StringBuilder ([24 days ago](https://dotnettips.com/2026/04/05/string-performance-avoid-unnecessary-conversions-with-stringbuilder/))
...
- Coding Faster with dotNetTips.com Spargine 10: April 2026 Release ([28 days ago](https://dotnettips.com/2026/04/01/coding-faster-with-dotnettips-com-spargine-10-april-2026-release/))
