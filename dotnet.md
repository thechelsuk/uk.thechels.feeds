...
<!-- news_marker starts -->
- Welcome to SkiaSharp 4.0 Preview 1 ([17 hours ago](https://devblogs.microsoft.com/dotnet/welcome-to-skia-sharp-40-preview1/))
- High-Performance Distributed Caching with .NET and Postgres on Azure ([17 hours ago](https://devblogs.microsoft.com/dotnet/high-performance-distributed-caching-dotnet-postgres-azure/))
