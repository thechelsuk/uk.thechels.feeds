...
<!-- news_marker starts -->
- Durable Workflows in the Microsoft Agent Framework ([22 hours ago](https://devblogs.microsoft.com/dotnet/durable-workflows-in-microsoft-agent-framework/))
...
- Building an AI-Powered Conference App with .NET’s Composable AI Stack ([6 days ago](https://devblogs.microsoft.com/dotnet/building-ai-conference-app-dotnet-composable-stack/))
- Governing MCP tool calls in .NET with the Agent Governance Toolkit ([7 days ago](https://devblogs.microsoft.com/dotnet/governing-mcp-tool-calls-in-dotnet-with-the-agent-governance-toolkit/))
- VSTest is Removing its Newtonsoft.Json Dependency ([7 days ago](https://devblogs.microsoft.com/dotnet/vs-test-is-removing-its-newtonsoft-json-dependency/))
