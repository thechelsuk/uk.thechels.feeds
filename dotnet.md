...
<!-- news_marker starts -->
- Modernize .NET Anywhere with GitHub Copilot ([1 hours ago](https://devblogs.microsoft.com/dotnet/modernize-dotnet-anywhere-with-ghcp/))
- .NET 10.0.5 Out-of-Band Release – macOS Debugger Fix ([1 hours ago](https://devblogs.microsoft.com/dotnet/dotnet-10-0-5-oob-release-macos-debugger-fix/))
- CollabTalk Podcast: Episode 183 with David McCarter ([12 hours ago](https://dotnettips.wordpress.com/2026/03/12/collabtalk-podcast-episode-183-with-david-mccarter/))
- UX Chronicles: How OpenAI Broke Sora ([12 hours ago](https://dotnettips.wordpress.com/2026/03/12/ux-chronicles-how-openai-broke-sora/))
...
- Extend your coding agent with .NET Skills ([2 days ago](https://devblogs.microsoft.com/dotnet/extend-your-coding-agent-with-dotnet-skills/))
